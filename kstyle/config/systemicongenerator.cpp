...
void SystemIconGenerator::generate()
{
    ...
    QString lightIconsPath = iconsPath + QStringLiteral("/helium");
    ...
    generateIconThemeDir(lightIconsPath, QStringLiteral("Helium"), m_internalSettings->heliumIconThemeInherits(), decorationColorsLight);

    QString darkIconsPath = iconsPath + QStringLiteral("/helium-dark");
    ...
    generateIconThemeDir(darkIconsPath, QStringLiteral("Helium Dark"), m_internalSettings->heliumDarkIconThemeInherits(), decorationColorsDark);
}
                                               ...
                                               const DecorationColors &decorationColors)
{
    ...
    iconThemeGroup.writeEntry("Comment", themeName + i18n(", Auto-generated by Helium window decoration"));
    ...
    for (int i = 0; i < m_scales.count(); i++) {
        for (auto size = m_iconSizes.begin(); size != m_iconSizes.end(); size++) {
            ...
            for (auto &iconType : m_iconTypes) {
                ...
                svgGenerator.setDescription(i18n("Auto-generated by Helium window decoration"));
